...
class ISCCore:
    ...
    def _auto_load_state(self):
        ...
        if state:
            try:
                ...
                self.knowledge_graph.graph = nx.node_link_graph(state["knowledge_graph"], edges="links")
    ...
    def save_state(self, filepath: Optional[str] = None):
        ...
        state = {
            ...
            "knowledge_graph": nx.node_link_data(self.knowledge_graph.graph, edges="links"),
